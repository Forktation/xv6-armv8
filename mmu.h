...
// shift how many bits to get PTE index
#define PTE_SHIFT 12
...
// maximum user-application memory, 256MB
#define UADDR_BITS 28
// maximum user address space size
#define UADDR_SZ (1 << UADDR_BITS)

// user page table size (1K)
#define PT_SZ (PTRS_PER_PTE << 3)
// physical address of the PT
#define PT_ADDR(v) align_dn(v, PT_SZ)
#define PT_ORDER 10
